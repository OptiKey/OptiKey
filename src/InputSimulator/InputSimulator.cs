namespace JuliusSweetland.ETTA.InputSimulator
{
    ...
    public class InputSimulator : IInputSimulator
    {
        ...
        /// </summary>
        private readonly IInputDeviceStateAdaptor inputDeviceStateAdaptor;
        ...
        public InputSimulator(IKeyboardSimulator keyboardSimulator, IMouseSimulator mouseSimulator, IInputDeviceStateAdaptor inputDeviceStateAdaptor)
        {
            ...
            this.inputDeviceStateAdaptor = inputDeviceStateAdaptor;
        }
        ...
        {
            get { return inputDeviceStateAdaptor; }
        }
    }
}