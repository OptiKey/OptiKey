...
namespace JuliusSweetland.OptiKey.Services
{
    public interface IWindowManipulationService : INotifyErrors
    {
        ...
        void MoveAndSize(bool inPersistNewState, string inWindowState, string inPosition, string inWidth, string inHeight, string inHorizontalOffset, string inVerticalOffset);
