            ...
            SerializableDictionaryOfTimeSpanByKeyValues dictionary)
        {
            return new List<KeyValueAndTimeSpanGroup>
            {
                ...
                new KeyValueAndTimeSpanGroup(Resources.MOUSE_DO_AT_POINT_KEY_GROUP, new List<KeyValueAndTimeSpan>
                {
                    ...
                    new KeyValueAndTimeSpan(Resources.LOOK_TO_SCROLL_ACTIVE_KEY_TEXT, KeyValues.LookToScrollActiveKey, dictionary.ContainsKey(KeyValues.LookToScrollActiveKey) ? dictionary[KeyValues.LookToScrollActiveKey] : (TimeSpan?)null),
