...
namespace JuliusSweetland.OptiKey.Models
{
    public static class KeyValues
    {
        ...
        public static readonly KeyValue CommuniKate_03key = new KeyValue(FunctionKeys.CommuniKate_03);
        public static readonly KeyValue CommuniKate_04key = new KeyValue(FunctionKeys.CommuniKate_04);
        public static readonly KeyValue CommuniKate_10key = new KeyValue(FunctionKeys.CommuniKate_10);
        public static readonly KeyValue CommuniKate_11key = new KeyValue(FunctionKeys.CommuniKate_11);
        public static readonly KeyValue CommuniKate_12key = new KeyValue(FunctionKeys.CommuniKate_12);
        public static readonly KeyValue CommuniKate_13key = new KeyValue(FunctionKeys.CommuniKate_13);
        public static readonly KeyValue CommuniKate_14key = new KeyValue(FunctionKeys.CommuniKate_14);
        public static readonly KeyValue CommuniKate_20key = new KeyValue(FunctionKeys.CommuniKate_20);
        public static readonly KeyValue CommuniKate_21key = new KeyValue(FunctionKeys.CommuniKate_21);
        public static readonly KeyValue CommuniKate_22key = new KeyValue(FunctionKeys.CommuniKate_22);
        public static readonly KeyValue CommuniKate_23key = new KeyValue(FunctionKeys.CommuniKate_23);
        public static readonly KeyValue CommuniKate_24key = new KeyValue(FunctionKeys.CommuniKate_24);
        public static readonly KeyValue CommuniKate_30key = new KeyValue(FunctionKeys.CommuniKate_30);
        public static readonly KeyValue CommuniKate_31key = new KeyValue(FunctionKeys.CommuniKate_31);
        public static readonly KeyValue CommuniKate_32key = new KeyValue(FunctionKeys.CommuniKate_32);
        public static readonly KeyValue CommuniKate_33key = new KeyValue(FunctionKeys.CommuniKate_33);
        public static readonly KeyValue CommuniKate_34key = new KeyValue(FunctionKeys.CommuniKate_34);
        ...
        public static readonly KeyValue CommuniKate_food = new KeyValue(FunctionKeys.CommuniKate_food);
        public static readonly KeyValue CommuniKate_leisure = new KeyValue(FunctionKeys.CommuniKate_leisure);
        public static readonly KeyValue CommuniKate_lunch = new KeyValue(FunctionKeys.CommuniKate_lunch);
        public static readonly KeyValue CommuniKate_flavour = new KeyValue(FunctionKeys.CommuniKate_flavour);
        public static readonly KeyValue CommuniKate_fizzydrinks = new KeyValue(FunctionKeys.CommuniKate_fizzydrinks);
        public static readonly KeyValue CommuniKate_furniture = new KeyValue(FunctionKeys.CommuniKate_furniture);
        public static readonly KeyValue CommuniKate_fastfood = new KeyValue(FunctionKeys.CommuniKate_fastfood);
        public static readonly KeyValue CommuniKate_places = new KeyValue(FunctionKeys.CommuniKate_places);
        public static readonly KeyValue CommuniKate_meal = new KeyValue(FunctionKeys.CommuniKate_meal);
        public static readonly KeyValue CommuniKate_clothes = new KeyValue(FunctionKeys.CommuniKate_clothes);
        public static readonly KeyValue CommuniKate_spellingcaps = new KeyValue(FunctionKeys.CommuniKate_spellingcaps);
        public static readonly KeyValue CommuniKate_gardening = new KeyValue(FunctionKeys.CommuniKate_gardening);
        public static readonly KeyValue CommuniKate_people = new KeyValue(FunctionKeys.CommuniKate_people);
        public static readonly KeyValue CommuniKate_specialdays = new KeyValue(FunctionKeys.CommuniKate_specialdays);
        public static readonly KeyValue CommuniKate_iwant = new KeyValue(FunctionKeys.CommuniKate_iwant);
        public static readonly KeyValue CommuniKate_computer = new KeyValue(FunctionKeys.CommuniKate_computer);
        public static readonly KeyValue CommuniKate_home = new KeyValue(FunctionKeys.CommuniKate_home);
        public static readonly KeyValue CommuniKate_sauces = new KeyValue(FunctionKeys.CommuniKate_sauces);
        public static readonly KeyValue CommuniKate_drinks = new KeyValue(FunctionKeys.CommuniKate_drinks);
        public static readonly KeyValue CommuniKate_describing = new KeyValue(FunctionKeys.CommuniKate_describing);
        public static readonly KeyValue CommuniKate_alcohol = new KeyValue(FunctionKeys.CommuniKate_alcohol);
        public static readonly KeyValue CommuniKate_supportstaff = new KeyValue(FunctionKeys.CommuniKate_supportstaff);
        public static readonly KeyValue CommuniKate_colours = new KeyValue(FunctionKeys.CommuniKate_colours);
        public static readonly KeyValue CommuniKate_moreactionwords = new KeyValue(FunctionKeys.CommuniKate_moreactionwords);
        public static readonly KeyValue CommuniKate_farmanimals = new KeyValue(FunctionKeys.CommuniKate_farmanimals);
        public static readonly KeyValue CommuniKate_pets = new KeyValue(FunctionKeys.CommuniKate_pets);
        public static readonly KeyValue CommuniKate_privateparts = new KeyValue(FunctionKeys.CommuniKate_privateparts);
        public static readonly KeyValue CommuniKate_christmas = new KeyValue(FunctionKeys.CommuniKate_christmas);
        public static readonly KeyValue CommuniKate_outsideplaces = new KeyValue(FunctionKeys.CommuniKate_outsideplaces);
        public static readonly KeyValue CommuniKate_nature = new KeyValue(FunctionKeys.CommuniKate_nature);
        public static readonly KeyValue CommuniKate_meatandfish = new KeyValue(FunctionKeys.CommuniKate_meatandfish);
        public static readonly KeyValue CommuniKate_idontfeelwell = new KeyValue(FunctionKeys.CommuniKate_idontfeelwell);
        public static readonly KeyValue CommuniKate_job = new KeyValue(FunctionKeys.CommuniKate_job);
        public static readonly KeyValue CommuniKate_petcare = new KeyValue(FunctionKeys.CommuniKate_petcare);
        public static readonly KeyValue CommuniKate_aboutyou = new KeyValue(FunctionKeys.CommuniKate_aboutyou);
        public static readonly KeyValue CommuniKate_wateranimals = new KeyValue(FunctionKeys.CommuniKate_wateranimals);
        public static readonly KeyValue CommuniKate_months = new KeyValue(FunctionKeys.CommuniKate_months);
        public static readonly KeyValue CommuniKate_days = new KeyValue(FunctionKeys.CommuniKate_days);
        public static readonly KeyValue CommuniKate_milkshake = new KeyValue(FunctionKeys.CommuniKate_milkshake);
        public static readonly KeyValue CommuniKate_artthings = new KeyValue(FunctionKeys.CommuniKate_artthings);
        public static readonly KeyValue CommuniKate_educationstaff = new KeyValue(FunctionKeys.CommuniKate_educationstaff);
        public static readonly KeyValue CommuniKate_cookingwords = new KeyValue(FunctionKeys.CommuniKate_cookingwords);
        public static readonly KeyValue CommuniKate_family = new KeyValue(FunctionKeys.CommuniKate_family);
        public static readonly KeyValue CommuniKate_myday = new KeyValue(FunctionKeys.CommuniKate_myday);
        public static readonly KeyValue CommuniKate_feelings = new KeyValue(FunctionKeys.CommuniKate_feelings);
        public static readonly KeyValue CommuniKate_channels = new KeyValue(FunctionKeys.CommuniKate_channels);
        public static readonly KeyValue CommuniKate_weather = new KeyValue(FunctionKeys.CommuniKate_weather);
        public static readonly KeyValue CommuniKate_toys = new KeyValue(FunctionKeys.CommuniKate_toys);
        public static readonly KeyValue CommuniKate_tools = new KeyValue(FunctionKeys.CommuniKate_tools);
        public static readonly KeyValue CommuniKate_yetmoreactionwords = new KeyValue(FunctionKeys.CommuniKate_yetmoreactionwords);
        public static readonly KeyValue CommuniKate_describingdrinks = new KeyValue(FunctionKeys.CommuniKate_describingdrinks);
        public static readonly KeyValue CommuniKate_unknown = new KeyValue(FunctionKeys.CommuniKate_unknown);
        public static readonly KeyValue CommuniKate_vegetables = new KeyValue(FunctionKeys.CommuniKate_vegetables);
        public static readonly KeyValue CommuniKate_sports = new KeyValue(FunctionKeys.CommuniKate_sports);
        public static readonly KeyValue CommuniKate_music = new KeyValue(FunctionKeys.CommuniKate_music);
        public static readonly KeyValue CommuniKate_kitchenequipment = new KeyValue(FunctionKeys.CommuniKate_kitchenequipment);
        public static readonly KeyValue CommuniKate_showpictures = new KeyValue(FunctionKeys.CommuniKate_showpictures);
        public static readonly KeyValue CommuniKate_bodyparts = new KeyValue(FunctionKeys.CommuniKate_bodyparts);
        public static readonly KeyValue CommuniKate_chatting = new KeyValue(FunctionKeys.CommuniKate_chatting);
        public static readonly KeyValue CommuniKate_opposites = new KeyValue(FunctionKeys.CommuniKate_opposites);
        public static readonly KeyValue CommuniKate_commonthings = new KeyValue(FunctionKeys.CommuniKate_commonthings);
        public static readonly KeyValue CommuniKate_animals = new KeyValue(FunctionKeys.CommuniKate_animals);
        public static readonly KeyValue CommuniKate_salad = new KeyValue(FunctionKeys.CommuniKate_salad);
        public static readonly KeyValue CommuniKate_snackspudding = new KeyValue(FunctionKeys.CommuniKate_snackspudding);
        public static readonly KeyValue CommuniKate_actionwords = new KeyValue(FunctionKeys.CommuniKate_actionwords);
        public static readonly KeyValue CommuniKate_personalcare = new KeyValue(FunctionKeys.CommuniKate_personalcare);
        public static readonly KeyValue CommuniKate_shops = new KeyValue(FunctionKeys.CommuniKate_shops);
        public static readonly KeyValue CommuniKate_scwfriends = new KeyValue(FunctionKeys.CommuniKate_scwfriends);
        public static readonly KeyValue CommuniKate_littlewords = new KeyValue(FunctionKeys.CommuniKate_littlewords);
        public static readonly KeyValue CommuniKate_juice = new KeyValue(FunctionKeys.CommuniKate_juice);
        public static readonly KeyValue CommuniKate_numbers = new KeyValue(FunctionKeys.CommuniKate_numbers);
        public static readonly KeyValue CommuniKate_breakfast = new KeyValue(FunctionKeys.CommuniKate_breakfast);
        public static readonly KeyValue CommuniKate_things = new KeyValue(FunctionKeys.CommuniKate_things);
        public static readonly KeyValue CommuniKate_nz = new KeyValue(FunctionKeys.CommuniKate_nz);
        public static readonly KeyValue CommuniKate_transport = new KeyValue(FunctionKeys.CommuniKate_transport);
        public static readonly KeyValue CommuniKate_positionwords = new KeyValue(FunctionKeys.CommuniKate_positionwords);
        public static readonly KeyValue CommuniKate_fruit = new KeyValue(FunctionKeys.CommuniKate_fruit);
        public static readonly KeyValue CommuniKate_toppage = new KeyValue(FunctionKeys.CommuniKate_toppage);
        public static readonly KeyValue CommuniKate_spelling = new KeyValue(FunctionKeys.CommuniKate_spelling);
        public static readonly KeyValue CommuniKate_friends = new KeyValue(FunctionKeys.CommuniKate_friends);
        public static readonly KeyValue CommuniKate_wildanimals = new KeyValue(FunctionKeys.CommuniKate_wildanimals);
        public static readonly KeyValue CommuniKate_potato = new KeyValue(FunctionKeys.CommuniKate_potato);
        public static readonly KeyValue CommuniKate_dvd = new KeyValue(FunctionKeys.CommuniKate_dvd);
        public static readonly KeyValue CommuniKate_toiletries = new KeyValue(FunctionKeys.CommuniKate_toiletries);
        public static readonly KeyValue CommuniKate_materials = new KeyValue(FunctionKeys.CommuniKate_materials);
        public static readonly KeyValue CommuniKate_mystories = new KeyValue(FunctionKeys.CommuniKate_mystories);
        public static readonly KeyValue CommuniKate_time = new KeyValue(FunctionKeys.CommuniKate_time);
