...
namespace JuliusSweetland.OptiKey.UI.Controls
{
    public class KeyboardHost : ContentControl
    {
        ...
        public KeyboardHost()
        {
            ...
            Settings.Default.OnPropertyChanges(s => s.KeyboardCurrentContext).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_00).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_01).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_02).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_03).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_04).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_10).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_11).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_12).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_13).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_14).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_20).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_21).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_22).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_23).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_24).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_30).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_31).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_32).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_33).Subscribe(_ => GenerateContent());
            Settings.Default.OnPropertyChanges(s => s.CommuniKateKeyboardCurrentContext_34).Subscribe(_ => GenerateContent());
