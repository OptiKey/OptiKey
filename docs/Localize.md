...
![OptiKey Dashboard](https://github.com/OptiKey/OptiKey/blob/master/docs/OptiKeyLocaleGuideImages/transifex_dashboard.jpg)
...
![OptiKey Project Selection](https://github.com/OptiKey/OptiKey/blob/master/docs/OptiKeyLocaleGuideImages/transifex_project_sel.jpg)

Then select the option to translate *English strings from Resource.resx* shown
below.

![OptiKey Project Selection](https://github.com/OptiKey/OptiKey/blob/master/docs/OptiKeyLocaleGuideImages/transifex_project_str_resx.jpg)

After clicking the last link you should be greeted with the following box

![OptiKey Project Selection](https://github.com/OptiKey/OptiKey/blob/master/docs/OptiKeyLocaleGuideImages/transifex_project_trans_box.jpg)
...
![OptiKey Project Selection](https://github.com/OptiKey/OptiKey/blob/master/docs/OptiKeyLocaleGuideImages/transifex_project_trans_page.jpg)
